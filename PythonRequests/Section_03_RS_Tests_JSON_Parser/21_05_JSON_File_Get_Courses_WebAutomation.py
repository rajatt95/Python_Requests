...
with open('files/MockResponse_GetCourse.json', 'r') as jsonFileReader:
    ...
    # Extract the list of Web Automation Course
    ...
    listOfWebAutomationCourses = dictionary_courses['courses']['webAutomation']
    for webAutomationCourse in listOfWebAutomationCourses:
        print(webAutomationCourse)
